...
public class TreatedFragment extends BaseFragment implements IRecyclerViewUi, SwipeRefreshLayout.OnRefreshListener,
    ...
    public void modifyCondition(String billNo, String Ip, String beginPtime, String endPtime,
    ...
    public void toRefreshRequest() {
        ...
        map.put("Rounter", NetConstant.GET_YUNW_REPAIR_TREATED);
