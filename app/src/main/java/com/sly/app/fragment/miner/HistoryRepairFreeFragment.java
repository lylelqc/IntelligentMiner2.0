...
import com.sly.app.adapter.miner.MinerRepairFreeRecyclerViewAdapter;
...
import com.sly.app.model.miner.MinerAllRepairFree;
...
public class HistoryRepairFreeFragment extends BaseFragment implements IRecyclerViewUi, ICommonViewUi, SwipeRefreshLayout.OnRefreshListener,
    ...
    private List<MinerRepairFreeListBean> mResultList = new ArrayList<>();
    ...
    protected void initViewsAndEvents() {
        ...
        toRequest(NetConstant.EventTags.GET_MINER_ALL_REPARE_FREE);
        firstRefresh();
    }
    ...
    public void toRefreshRequest() {
        ...
        map.put("Rounter", NetConstant.GET_MINER_REPARE_LIST);
    ...
    public void getRefreshData(int eventTag, String result) {
        ...
        List<MinerRepairFreeListBean> resultList =
                (List<MinerRepairFreeListBean>) AppUtils.parseRowsResult(result, MinerRepairFreeListBean.class);
    ...
    public void toRequest(int eventTag) {
        ...
        if (eventTag == NetConstant.EventTags.GET_MINER_ALL_REPARE_FREE) {
            map.put("Rounter", NetConstant.GET_MINER_ALL_REPARE_FREE);
            map.put("machineSysCode", machineSysCode);
        }
    ...
    public void getRequestData(int eventTag, String result) {
        if (eventTag == NetConstant.EventTags.GET_MINER_ALL_REPARE_FREE) {
            List<MinerAllRepairFree> bean = (List<MinerAllRepairFree>) AppUtils.parseRowsResult(result, MinerAllRepairFree.class);
    ...
    public void refreshListView() {
        ...
        MinerRepairFreeRecyclerViewAdapter mIntermediary =
                new MinerRepairFreeRecyclerViewAdapter(mContext, mResultList, Model);
