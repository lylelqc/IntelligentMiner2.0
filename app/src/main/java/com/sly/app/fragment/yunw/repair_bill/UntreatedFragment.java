...
public class UntreatedFragment extends BaseFragment implements IRecyclerViewUi, SwipeRefreshLayout.OnRefreshListener,
    ...
    public void toRefreshRequest() {
        ...
        map.put("Rounter", NetConstant.GET_YUNW_REPAIR_UNTREATED);
