...
public class MinerTreatingFragment extends BaseFragment implements IRecyclerViewUi, SwipeRefreshLayout.OnRefreshListener,
    ...
    public void modifyCondition(String billNo, String machineCode, String beginPtime, String endPtime, String Status){
    ...
    public void toRefreshRequest() {
        ...
        map.put("Rounter", NetConstant.GET_MINER_TREATING_LIST);
