...
public class MinerTreatedFragment extends BaseFragment implements IRecyclerViewUi, SwipeRefreshLayout.OnRefreshListener,
    ...
    public void modifyCondition(String billNo, String machineCode, String beginPtime, String endPtime,
    ...
    public void modifyMachineSysCode(String MachineSysCode){
    ...
    public void toRefreshRequest() {
        ...
        map.put("Rounter", NetConstant.GET_MINER_TREATED_LIST);
    ...
    public void refreshListView() {
        MinerRepairBillRecyclerViewAdapter mIntermediary = new MinerRepairBillRecyclerViewAdapter(mContext, mResultList, false);
