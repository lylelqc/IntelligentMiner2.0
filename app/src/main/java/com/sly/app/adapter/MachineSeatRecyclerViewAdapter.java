...
//           }
    ...
    private class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            super(view);
            mImg = view.findViewById(R.id.id_head_machine);
            mTitle = view.findViewById(R.id.tv_title);
            mAuthIcon = view.findViewById(R.id.iv_rz_status);
            mMsg = view.findViewById(R.id.tv_msg);
            mAddress = view.findViewById(R.id.tv_address);
            mNumber = view.findViewById(R.id.tv_number);
            mPrice = view.findViewById(R.id.tv_price);
            mRlItem = view.findViewById(R.id.rl_item);
            mDeleteSeat = view.findViewById(R.id.rl_delete_seat);
        }
    }
}
