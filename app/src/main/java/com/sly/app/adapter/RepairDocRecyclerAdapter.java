...
//        Logcat.e("MachineListRecyclerViewAdapter - " + beanList.toString());
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if(beanList.size() != 0){
            ...
            if(rdBean.getResultname().equals("未处理")){
                ...
                eholder.mRepairStatus.setTextColor(context.getResources().getColor(R.color.sly_text_blue2));
            }else{
    ...
    private class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            mRepairStatus = view.findViewById(R.id.tv_repair_status);
            mRepairIP = view.findViewById(R.id.tv_repair_IP);
            mRepairArea = view.findViewById(R.id.tv_repair_area);
            mRepairBegin = view.findViewById(R.id.tv_begin_time);
            mRepairEnd = view.findViewById(R.id.tv_end_time);
            mQuestionDesciption = view.findViewById(R.id.tv_question_desciption);
            mRepairDocDetails = view.findViewById(R.id.rl_details);
            mRepairEndTime = view.findViewById(R.id.rl_repair_end_time);
        }
    }
}
