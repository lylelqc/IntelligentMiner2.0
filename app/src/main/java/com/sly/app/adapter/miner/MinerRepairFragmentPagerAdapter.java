...
public class MinerRepairFragmentPagerAdapter extends FragmentPagerAdapter {

    private static final int MAX_TAB_COUNT = 3;
    private List<CharSequence> mTitleList = new ArrayList<>();

    public MinerRepairFragmentPagerAdapter(FragmentManager fragmentManager) {
    ...
    public Fragment getItem(int position) {
        switch (position) {
            case 0:
                return new MinerConfirmingFragment();
            case 1:
                return new MinerTreatingFragment();
            case 2:
                return new MinerTreatedFragment();
