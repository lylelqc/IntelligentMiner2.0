...
public class MasterMachineTypeRecyclerViewAdapter extends RecyclerView.Adapter {

    private Context mContext;
    private List<MasterMachineTypeBean> beanList;
    private int index = -1;//标记当前选择的选项

    public MasterMachineTypeRecyclerViewAdapter(Context context, List<MasterMachineTypeBean> beanList) {
