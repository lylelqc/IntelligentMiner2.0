...
public class ScanDetailsRecyclerViewAdapter extends RecyclerView.Adapter implements View.OnClickListener {
    ...
    private class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            super(view);
            mMachineCount = view.findViewById(R.id.tv_machine_count);
            mMinerCode = view.findViewById(R.id.tv_mine_number);
            mBindNum = view.findViewById(R.id.tv_bind_number);
            mBindBtn = view.findViewById(R.id.tv_bind_btn);
            mMachineListBtn = view.findViewById(R.id.tv_machine_list_btn);
        }
    }
}
