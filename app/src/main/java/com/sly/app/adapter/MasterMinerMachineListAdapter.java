...
//            eholder.itemView.setTag(position);
    ...
    private class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            super(view);
            mMasterMinerIcon = view.findViewById(R.id.iv_head_img);
            mMineName = view.findViewById(R.id.tv_mine_name_1);
            mMachineModel = view.findViewById(R.id.tv_machine_model);
            mOperationRate = view.findViewById(R.id.tv_operation_rate);
            mMachineNum = view.findViewById(R.id.tv_machine_num);
            mCalForce = view.findViewById(R.id.tv_cal_force);
            mBadCount = view.findViewById(R.id.tv_bad_count);
            mMachineList = view.findViewById(R.id.tv_machine_list);
            mBadList = view.findViewById(R.id.tv_bad_list);
        }
    }
}
