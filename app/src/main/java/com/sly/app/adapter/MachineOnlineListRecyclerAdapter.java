...
import com.sly.app.activity.sly.mine.CheckAreaActivity;
import com.sly.app.activity.sly.mine.MachineListActivity;
import com.sly.app.activity.sly.mine.ScanDetailsActivity;
...
public class MachineOnlineListRecyclerAdapter extends RecyclerView.Adapter {
    ...
    private class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            super(view);
            mPlanID = (TextView) view.findViewById(R.id.tv_plan_id);
            mCheckArea = (TextView) view.findViewById(R.id.tv_check_area);
            mMachineList = (TextView) view.findViewById(R.id.tv_machine_list);
            mScanCount = (TextView) view.findViewById(R.id.tv_scan_count);
            mExecute = (TextView) view.findViewById(R.id.tv_execute);
            mStartTime = (TextView) view.findViewById(R.id.tv_execute_time);
            mStatus = (TextView) view.findViewById(R.id.tv_bind_status);
            mExecuteTimel = (TextView) view.findViewById(R.id.tv_start_time);
            mBindStatus = (RelativeLayout) view.findViewById(R.id.rl_status);
            mDetails = (RelativeLayout) view.findViewById(R.id.rl_details);
        }
    }
}