...
//                    context.startActivity(intent);
    ...
    private class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            tv_machine_count = view.findViewById(R.id.tv_machine_count);
            tv_run_hours = view.findViewById(R.id.tv_run_hours);
            tv_run_rate = view.findViewById(R.id.tv_run_rate);
