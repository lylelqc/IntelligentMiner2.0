...
public class StatusLayoutManager extends RelativeLayout {
    private static final String TAG = "StatusLayoutManager";
    ...
    public StatusLayoutManager(Context context) {
        this(context, null);
    }

    public StatusLayoutManager(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public StatusLayoutManager(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.StatusLayoutManager, defStyleAttr, 0);
        mEmptyViewResId = a.getResourceId(R.styleable.StatusLayoutManager_emptyView, R.layout.empty_view);
        mErrorViewResId = a.getResourceId(R.styleable.StatusLayoutManager_errorView, R.layout.error_view);
        mLoadingViewResId = a.getResourceId(R.styleable.StatusLayoutManager_loadingView, R.layout.loading_view);
        mNoNetworkViewResId = a.getResourceId(R.styleable.StatusLayoutManager_noNetworkView, R.layout.no_network_view);
        mContentViewResId = a.getResourceId(R.styleable.StatusLayoutManager_contentView, NULL_RESOURCE_ID);
        a.recycle();
