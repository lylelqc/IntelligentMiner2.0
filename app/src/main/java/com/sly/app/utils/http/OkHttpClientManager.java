...
public class OkHttpClientManager
{
    ...
    public static void postJson(String url, Map<String, String> bodyStr, final ResultCallback callback)
    {
        getInstance().getPostDelegate().postJson(url, bodyStr,callback);
    }
    ...
    public class PostDelegate
    {
        ...
        public  final MediaType MEDIA_TYPE = MediaType.parse("text/plain;");
        /**
         * 同步的Post请求
         */
        ...
        public void postJson(String url, Map<String, String> params, final ResultCallback callback)
        {
            String json = CommonUtils.GsonToJson(params);
