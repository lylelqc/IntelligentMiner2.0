...
public class SercurityDialog extends Dialog implements View.OnClickListener {
    ...
    private void initView() {
        mNum0 = findViewById(R.id.button0);
        mNum1 = findViewById(R.id.button1);
        mNum2 = findViewById(R.id.button2);
        mNum3 = findViewById(R.id.button3);
        mNum4 = findViewById(R.id.button4);
        mNum5 = findViewById(R.id.button5);
        mNum6 = findViewById(R.id.button6);
        mNum7 = findViewById(R.id.button7);
        mNum8 = findViewById(R.id.button8);
        mNum9 = findViewById(R.id.button9);
        //洗牌
        ...
        mDelPwd = findViewById(R.id.button_del);
        mLayoutBack = findViewById(R.id.rl_back);
...
//                getOwnerActivity().finish();
        ...
        mPwdImg1 = findViewById(R.id.pwd_1);
        mPwdImg2 = findViewById(R.id.pwd_2);
        mPwdImg3 = findViewById(R.id.pwd_3);
        mPwdImg4 = findViewById(R.id.pwd_4);
        mPwdImg5 = findViewById(R.id.pwd_5);
        mPwdImg6 = findViewById(R.id.pwd_6);
        ...
        mOrderPrice = findViewById(R.id.tv_OrderPrice);
