...
public class TimeDialogChoos {
    ...
    public static Dialog setTimeDialog(android.content.Context context, final onInputNameEvent listener, int sceenwith, String defulData) {
        ...
        mWheelYear = (WheelView) layout.findViewById(R.id.year);
        mWheelMonth = (WheelView) layout.findViewById(R.id.month);
        mWheelDay = (WheelView) layout.findViewById(R.id.day);
        ...
        Button mSure = (Button) layout.findViewById(R.id.dialogtool_time_select_sure);
