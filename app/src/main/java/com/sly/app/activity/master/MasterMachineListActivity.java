...
public class MasterMachineListActivity extends BaseActivity implements ICommonViewUi, IRecyclerViewUi, SwipeRefreshLayout.OnRefreshListener,
    ...
    private List<MasterMachineListBean> mResultList = new ArrayList<>();
...
//        PersonSysCode = SharedPreferencesUtil.getString(mContext, "PersonSysCode", "None");
    ...
    public void toRefreshRequest() {
        ...
        map.put("Rounter", NetConstant.GET_MASTER_MACHINE_LIST);
    ...
    public void getRefreshData(int eventTag, String result) {
        ...
        List<MasterMachineListBean> resultList =
                (List<MasterMachineListBean>) AppUtils.parseRowsResult(result, MasterMachineListBean.class);
    ...
    public void refreshListView() {
        MasterMachineListRecyclerViewAdapter mIntermediary = new MasterMachineListRecyclerViewAdapter(mContext, mResultList);
