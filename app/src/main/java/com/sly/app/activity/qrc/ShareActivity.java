...
public class ShareActivity extends BaseActivity {
    ...
    private void ShareDialog() {
        ...
        dialog.show();
        LinearLayout shareToWx = dialog.findViewById(R.id.iv_wx);
        LinearLayout shareToWx2 = dialog.findViewById(R.id.iv_wx2);
        LinearLayout shareToQQ = dialog.findViewById(R.id.iv_qq1);
        LinearLayout shareToQzone = dialog.findViewById(R.id.iv_qq2);
        TextView tv_cance_share = dialog.findViewById(R.id.tv_cance_share);
