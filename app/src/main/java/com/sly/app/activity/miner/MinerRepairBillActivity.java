...
import com.sly.app.adapter.miner.MinerRepairFragmentPagerAdapter;
import com.sly.app.adapter.yunw.repair.RepairFragmentPaperAdapter;
import com.sly.app.comm.EventBusTags;
import com.sly.app.fragment.miner.MinerConfirmingFragment;
import com.sly.app.fragment.miner.MinerTreatedFragment;
import com.sly.app.fragment.miner.MinerTreatingFragment;
...
public class MinerRepairBillActivity extends BaseActivity implements RepairCheckPopView.OnSearchClickListener {
    ...
    private MinerRepairFragmentPagerAdapter mTabAdapter;
    ...
    public void onEvent(PostResult postResult) {
        ...
        if(EventBusTags.JUMP_MIENR_REPAIR_BILL_TREATED.equals(postResult.getTag())){
    ...
    private void initViews() {
        ...
        mTabAdapter = new MinerRepairFragmentPagerAdapter(getSupportFragmentManager());
        mTabAdapter.addTab(getString(R.string.repair_confirming));
        ...
        heathTab.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                if(tab.getText().equals(getString(R.string.repair_confirming))) {
                    count = 1;
                }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()){
            ...
            case R.id.rl_repair_check:
                ...
                mRepairCheckView = new RepairCheckPopView(this, count, 1);
                mRepairCheckView.setOnDismissListener(new PopupWindow.OnDismissListener() {
                    ...
                    public void onDismiss() {
                        ...
                        tvRepairCheck.setCompoundDrawablesWithIntrinsicBounds(getResources().getDrawable(R.drawable.sousuo_weixiudan_icon),
                                null, null, null);
                        tvRepairCheck.setCompoundDrawablePadding(AppUtils.dp2px(MinerRepairBillActivity.this, 5));
    ...
    public void onSearchClick(View view, int position) {
        if(mRepairCheckView != null ){
            ...
            if (mTabAdapter != null && viewpagerHeathTab != null)
            {
                ...
                if (obj != null && count == 1)
                {
                    MinerConfirmingFragment fragment = (MinerConfirmingFragment) obj;
                    fragment.modifyCondition(BillNo, IP, beginTime1, beginTime2);
                }
                else if (obj != null && count == 2)
                {
                    MinerTreatingFragment fragment = (MinerTreatingFragment) obj;
                    fragment.modifyCondition(BillNo, IP, beginTime1, beginTime2, status);
                }
                else if (obj != null && count == 3)
                {
                    MinerTreatedFragment fragment = (MinerTreatedFragment) obj;
